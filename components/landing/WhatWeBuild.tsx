...
const cards = [
  {
    ...
    linkRef: "/login",
    linkStyle: "text-[#A78BFA] hover:text-[#C4B5FD] transition-colors",
    clickable: true
  },
  {
    id: "edu",
      ...
      <div className="max-w-[1280px] mx-auto px-[20px] md:px-[80px]">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h2 
            ...
            className="font-display font-bold text-[30px] md:text-[42px] text-[#F5F3FF] tracking-[-0.02em] mb-[16px]"
          >
            One Vision. <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(135deg, #A78BFA 0%, #FBBF24 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Three</span> Dimensions.
          </motion.h2>
          ...
          <motion.p 
            ...
            className="font-sans font-normal text-[16px] md:text-[18px] text-[#A8A0C0] max-w-[550px] mx-auto leading-[1.6] mb-[64px]"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px]">
          {cards.map((card, idx) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="font-display font-semibold text-[22px] text-[#F5F3FF] mb-[12px]">
                {card.title}
              </h3>
