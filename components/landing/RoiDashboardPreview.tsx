      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-[20px] md:px-[60px] flex flex-col items-center">
        ...
        <div className="flex flex-col items-center text-center mb-[56px]">
          ...
          <motion.h2 
            ...
            className="font-display font-bold text-[34px] md:text-[42px] text-[#F5F3FF] tracking-[-0.02em] leading-tight mb-[16px]"
          >
            See <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(135deg, #A78BFA 0%, #FBBF24 100%)' }}>Exactly</span> What Your AI Is Doing.
          </motion.h2>
          ...
          <motion.p 
            ...
            className="font-sans font-normal text-[16px] md:text-[18px] text-[#A8A0C0] max-w-[500px] leading-[1.6]"
          >
        ...
        >
          {/* Live Preview Label */}
          <div className="absolute top-[-14px] left-[32px] bg-[rgba(139,92,246,0.1)] border border-[rgba(139,92,246,0.3)] text-[#A78BFA] font-mono font-medium text-[11px] px-[12px] py-[4px] rounded-[6px] z-20 shadow-[0_0_15px_rgba(139,92,246,0.15)] backdrop-blur-sm tracking-wide">
          ...
          <div className="flex flex-col md:flex-row gap-[16px] mb-[32px] mt-[12px]">
            ...
            <div className="flex-1 bg-[#0C0118] border border-[#1E0A35] rounded-[12px] p-[20px] flex flex-col justify-between items-start relative overflow-hidden transition-all duration-300 hover:border-[#8B5CF6]/50">
              ...
              <div className="font-display font-bold text-[36px] text-[#F5F3FF] leading-none mb-[8px]">
          ...
          <div className="w-full bg-[#0C0118] border border-[#1E0A35] rounded-[12px] p-[20px] flex flex-col relative h-[240px]">
            <div className="flex items-center justify-between mb-[24px]">
              <div className="text-[13px] font-sans font-medium text-[#A8A0C0]">This Week's Call Volume</div>
            </div>
