...
export async function GET(req: Request) {
  try {
    ...
    // Fetch existing integration row for this agent
    ...
    const emailConfig = decryptJson(data.whatsapp_phone_number_id) // stored in whatsapp_phone_number_id
    const calendarConfig = decryptJson(data.telegram_bot_token) // stored in telegram_bot_token
