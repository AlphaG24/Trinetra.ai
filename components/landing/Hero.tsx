...
function getVoiceStatusCopy({
  ...
  if (error) {
    return "We couldn't connect to the AI agent right now. Please try again.";
  }

  if (isConnecting) {
    return "Connecting to our AI voice agent. Browser web calls usually take 5-10 seconds.";
  }

  if (isConnected && isSpeaking) {
    return "Our AI agent is speaking now. Reply naturally when it pauses.";
  }

  if (isConnected) {
    return "You are live with our AI voice agent now. Start speaking naturally.";
  }
    ...
    <section className="relative flex h-[100vh] w-full flex-col items-center justify-center overflow-hidden bg-[#080010] pt-[72px] text-center">
      ...
      <div className="relative z-10 -mt-[100px] flex w-full flex-col items-center justify-center px-6 md:-mt-[140px]">
        ...
        <motion.h1
          ...
          className="mb-[20px] font-display text-[38px] font-bold leading-tight tracking-[-0.02em] text-[#F5F3FF] sm:text-[46px] md:text-[64px] lg:text-[76px]"
        >
          The{" "}
          <span
        ...
        <motion.p
          ...
          className="mx-auto mb-[36px] max-w-[540px] font-sans text-[16px] font-normal leading-[1.7] text-[#A8A0C0] md:text-[18px]"
        >
        ...
        >
          <Link
            href="/contact"
            className="group relative flex items-center justify-center rounded-full bg-[#0C0118] px-[36px] py-[16px] font-sans text-[18px] font-medium text-[#F5F3FF] shadow-[0_0_25px_rgba(139,92,246,0.3)] transition-all duration-300 hover:-translate-y-[2px] hover:shadow-[0_0_45px_rgba(139,92,246,0.5)]"
          >
          ...
          <button
            ...
            className="group relative cursor-pointer rounded-full bg-[#0C0118] px-[36px] py-[16px] font-sans text-[18px] font-medium text-[#A8A0C0] shadow-[0_0_20px_rgba(139,92,246,0.1)] transition-all duration-300 hover:-translate-y-[2px] hover:text-[#F5F3FF] hover:shadow-[0_0_35px_rgba(139,92,246,0.25)]"
          >
