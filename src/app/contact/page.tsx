    ...
    <Layout>
      <div className="relative flex min-h-screen flex-col overflow-hidden bg-[#080010] px-[20px] pb-[100px] pt-[140px]">
        <div className="relative z-10 mx-auto grid w-full max-w-[1200px] grid-cols-1 gap-[60px] lg:grid-cols-[55%_40%] lg:justify-between">
          ...
          >
            <div className="mb-[24px] inline-block self-start rounded-full border border-[rgba(139,92,246,0.15)] bg-[rgba(139,92,246,0.1)] px-[16px] py-[6px] font-sans text-[13px] font-medium text-[#D7C4F7]">
              Get in Touch
            </div>

            <h1 className="mb-[16px] font-display text-[36px] font-bold leading-tight tracking-[-0.02em] text-[#FAF7FF] md:text-[44px]">
              Let&apos;s Build Something Together.
            </h1>

            <p className="mb-[36px] font-sans text-[16px] font-normal text-[#B8B0D1]">
          ...
          >
            <h2 className="mb-[28px] font-display text-[20px] font-semibold text-[#FAF7FF]">
              Contact Information
            </h2>
            ...
            <div className="flex flex-col gap-[20px]">
              {hasConfiguredValue(companyEmail) ? (
                <div className="flex items-center gap-[16px]">
                  ...
                  <a
                    ...
                    className="font-sans text-[15px] font-normal text-[#B8B0D1] transition-colors hover:text-[#FAF7FF]"
                  >
                    {companyEmail}
                  </a>
                </div>
              ...
              {hasConfiguredValue(phone1) || hasConfiguredValue(phone2) ? (
                <div className="flex items-start gap-[16px]">
                  ...
                  <div className="flex flex-col gap-[10px]">
                    <span className="font-sans text-[15px] font-medium text-[#FAF7FF]">Call Us</span>
              ...
              <div className="flex items-start gap-[16px]">
                ...
                <span className="font-sans text-[15px] font-normal leading-[1.6] text-[#B8B0D1]">
                  India
                  <br />
            ...
            <h3 className="mb-[20px] font-display text-[16px] font-semibold text-[#FAF7FF]">
              Connect With Us
            </h3>
            <div className="flex items-center gap-[16px]">
              {linkedinUrl ? (
                <a
                  ...
                  rel="noreferrer"
                  aria-label="LinkedIn"
                  className="flex h-[36px] w-[36px] items-center justify-center rounded-full bg-transparent text-[#6B6088] transition-colors duration-300 hover:bg-[rgba(139,92,246,0.1)] hover:text-[#FAF7FF]"
                >
                  <Linkedin size={18} />
                </a>
              ) : null}
            ...
            <h3 className="mb-[12px] font-display text-[16px] font-semibold text-[#FAF7FF]">
              Get In Touch
            </h3>
            <p className="mb-[24px] font-sans text-[14px] font-normal leading-[1.6] text-[#B8B0D1]">
          ...
          <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-[rgba(8,0,16,0.8)] p-4 backdrop-blur-md">
            ...
            >
              <button
                ...
                className="absolute right-4 top-4 text-[#6B6088] transition-colors hover:text-[#FAF7FF]"
                title="Close"
              >
                <X size={20} />
              </button>
              ...
              <form onSubmit={handleCallbackSubmit} className="flex flex-col gap-4">
                <input
                  ...
                  className="w-full rounded-[10px] border border-[#2D1255] bg-[#0C0118] px-[16px] py-[14px] text-[#FAF7FF] placeholder:text-[#6B6088] outline-none transition-colors focus:border-[#8B5CF6]"
                  required
                />
                <button
                  type="submit"
