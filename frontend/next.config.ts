...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    // Only apply HSTS when explicitly enabled (e.g. real production with SSL/HTTPS domain)
    // Disabled on IP-based or HTTP test environments to avoid forced HTTPS redirects.
    if (enableHsts) {
      securityHeaders.push({
