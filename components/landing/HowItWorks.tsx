      ...
      <div className="max-w-[1280px] mx-auto px-[20px] md:px-[80px]">
        ...
        <div className="flex flex-col items-center text-center mb-[72px]">
          ...
          <motion.p 
            ...
            className="font-sans font-normal text-[16px] md:text-[18px] text-[#A8A0C0] max-w-[500px] mx-auto leading-[1.6]"
          >
            ...
            {steps.map((step, idx) => (
              ...
              >
                ...
                <div className="flex flex-col items-start md:items-center md:max-w-[280px]">
                  <h3 className="font-display font-semibold text-[18px] md:text-[20px] text-[#F5F3FF] mb-[12px] leading-snug">
                    {step.title}
                  </h3>
                  <p className="font-sans font-normal text-[14px] md:text-[15px] text-[#A8A0C0] leading-[1.6]">
                    {step.desc}
                  </p>
                </div>
              </motion.div>
