...
const PLAN_ACCENTS = ["#A78BFA", "#06B6D4", "#F59E0B"];
...
function getFeatureToneTextClass(tone: Exclude<FeatureTone, "default">) {
  if (tone === "included") return "text-[#F5F3FF]";
...
function renderComparisonCell(value: ComparisonValue) {
  ...
  if (tone === "default") {
    return <span className="text-[#F5F3FF]">{value.text}</span>;
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full flex-col">
        <h3 className="font-display text-[24px] font-semibold text-[#F5F3FF]">{plan.name}</h3>
        ...
        <div className="mt-[20px] min-h-[128px]">
          ...
          <div className="relative min-h-[58px] overflow-hidden">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="font-display text-[46px] font-bold leading-none tracking-[-0.03em] text-[#F5F3FF]">
                  {displayPrice}
                </div>
        ...
        {plan.description ? <p className="mt-[14px] min-h-[42px] font-sans text-[14px] leading-[1.6] text-[#A8A0C0]">{plan.description}</p> : null}
      ...
      <div className="min-h-screen bg-[#080010]">
        <section className="relative overflow-hidden px-[20px] pb-[54px] pt-[140px] text-center">
          ...
          <div className="relative z-10 mx-auto max-w-[760px]">
            <div className="mb-[24px] inline-flex rounded-full border border-[rgba(139,92,246,0.15)] bg-[rgba(139,92,246,0.1)] px-[16px] py-[6px] font-sans text-[13px] font-medium text-[#A78BFA]">
              {"\u2726"} Pricing
            </div>
            <h1 className="font-display text-[38px] font-bold tracking-[-0.02em] text-[#F5F3FF] md:text-[52px]">
              Simple Plans. Real Results.
            </h1>
            <p className="mx-auto mt-[18px] max-w-[500px] font-sans text-[16px] leading-[1.7] text-[#A8A0C0]">
        ...
        {loading ? (
          <section className="px-[20px] pb-[100px]">
            <div className="mx-auto max-w-[1180px] rounded-[20px] border border-[#1E0A35] bg-[#130224] px-[24px] py-[48px] text-center font-sans text-[16px] text-[#A8A0C0]">
              Loading pricing...
            </div>
          </section>
        ) : plans.length === 0 ? (
          ...
          <>
            ...
            <section className="px-[20px] pb-[60px]">
              <div className="mx-auto max-w-[1180px]">
                <div className="text-center">
                  <h2 className="font-display text-[30px] font-semibold text-[#F5F3FF]">
                    Detailed Feature Comparison
                  </h2>
                  <p className="mx-auto mt-[12px] max-w-[560px] font-sans text-[15px] leading-[1.7] text-[#A8A0C0]">
                      ...
                      <div className="mt-[24px] overflow-hidden rounded-[24px] border border-[#1E0A35] bg-[#130224]">
                        <div className="overflow-x-auto">
                          <table className="w-full min-w-[920px] border-collapse">
                            <thead className="sticky top-0 z-10 bg-[#10021E]">
                              <tr className="border-b border-[#1E0A35]">
                                ...
                                {plans.map((plan, index) => (
                                  <th
                                    key={`${plan.slug}-head`}
                                    className="px-[16px] py-[16px] text-center font-sans text-[14px] font-semibold text-[#F5F3FF]"
                                  >
                              ...
                              <tbody key={group.title}>
                                <tr className="bg-[rgba(255,255,255,0.02)]">
                                  <td
                                    ...
                                    className="px-[16px] py-[12px] text-left font-sans text-[12px] font-semibold uppercase tracking-[0.12em] text-[#A78BFA]"
                                  >
                                    {group.title}
                                  </td>
                                </tr>
                                {group.rows.map((row, rowIndex) => (
                                  <tr key={`${group.title}-${row.label}`} className={rowIndex % 2 === 0 ? "bg-transparent" : "bg-[rgba(255,255,255,0.015)]"}>
                                    <td className="border-t border-[rgba(255,255,255,0.04)] px-[16px] py-[14px] font-sans text-[14px] text-[#A8A0C0]">
                                      {row.label}
                                    </td>
            ...
            <section className="px-[20px] pb-[60px]">
              <div className="mx-auto max-w-[1180px]">
                <div className="text-center">
                  <h2 className="font-display text-[30px] font-semibold text-[#F5F3FF]">Overage Charges</h2>
                  <p className="mx-auto mt-[12px] max-w-[420px] font-sans text-[15px] leading-[1.7] text-[#A8A0C0]">
                          ...
                          <tr key={row.label} className={index % 2 === 0 ? "bg-transparent" : "bg-[rgba(255,255,255,0.015)]"}>
                            ...
                            {row.values.map((value, valueIndex) => (
                              <td
                                ...
                                className="border-t border-[rgba(255,255,255,0.04)] px-[16px] py-[14px] text-center font-sans text-[14px] text-[#F5F3FF]"
                              >
                                {value}
                              </td>
                            ))}
                ...
                <div className="mt-[20px] rounded-[20px] border border-[rgba(139,92,246,0.15)] bg-[rgba(139,92,246,0.06)] p-[20px]">
                  <div className="flex items-start gap-[12px]">
                    <Info size={18} className="mt-[2px] shrink-0 text-[#A78BFA]" />
                    <div>
                      <div className="font-sans text-[14px] font-semibold text-[#F5F3FF]">How overages work:</div>
                      <div className="mt-[10px] space-y-[6px] font-sans text-[14px] leading-[1.6] text-[#A8A0C0]">
            ...
            <section className="px-[20px] pb-[60px]">
              <div className="mx-auto max-w-[1180px]">
                <div className="text-center">
                  <h2 className="font-display text-[30px] font-semibold text-[#F5F3FF]">Add-Ons</h2>
                  <p className="mx-auto mt-[12px] max-w-[520px] font-sans text-[15px] leading-[1.7] text-[#A8A0C0]">
                ...
                <div className="mt-[24px] grid grid-cols-1 gap-[16px] md:grid-cols-2 xl:grid-cols-3">
                  {ADD_ONS.map((addon) => (
                    <div key={addon.title} className="rounded-[20px] border border-[#1E0A35] bg-[#130224] p-[20px]">
                      <div className="font-display text-[18px] font-semibold text-[#F5F3FF]">{addon.title}</div>
                      <p className="mt-[10px] font-sans text-[13px] leading-[1.7] text-[#A8A0C0]">{addon.description}</p>
            ...
            <section className="border-t border-[#1E0A35] bg-[#0C0118] px-[20px] py-[100px]">
              <div className="mx-auto max-w-[820px]">
                <div className="text-center">
                  <h2 className="font-display text-[32px] font-semibold text-[#F5F3FF]">
                  ...
                  {FAQS.map((faq, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span className="font-sans text-[16px] font-semibold text-[#F5F3FF]">{faq.question}</span>
                          <span
                            className={`inline-flex h-[24px] w-[24px] items-center justify-center rounded-full border border-[#2D1255] text-[#A78BFA] transition-transform duration-200 ${isOpen ? "rotate-45" : ""}`}
                          >
                            +
                          </span>
                        </button>
                        ...
                        <AnimatePresence initial={false}>
                          {isOpen ? (
                            <motion.div
                              ...
                              className="overflow-hidden"
                            >
                              <p className="pt-[12px] font-sans text-[15px] leading-[1.7] text-[#A8A0C0]">{faq.answer}</p>
                            </motion.div>
                          ) : null}
                        </AnimatePresence>
                      </div>
            ...
            <section className="px-[20px] pb-[110px] pt-[90px] text-center">
              <div className="mx-auto max-w-[760px] rounded-[28px] border border-[#1E0A35] bg-[linear-gradient(180deg,rgba(19,2,36,0.95),rgba(12,1,24,0.98))] px-[24px] py-[42px] shadow-[0_20px_60px_rgba(0,0,0,0.28)]">
                <h2 className="font-display text-[34px] font-semibold text-[#F5F3FF]">Not Sure Which Plan Fits?</h2>
                <p className="mx-auto mt-[14px] max-w-[520px] font-sans text-[16px] leading-[1.7] text-[#A8A0C0]">
