      ...
      <div className="mx-auto max-w-[1280px] px-[20px] md:px-[80px]">
        <div className="mb-[64px] flex flex-col items-center text-center">
          ...
          <motion.h2
            ...
            className="mb-[16px] font-display text-[32px] font-bold leading-tight tracking-[-0.02em] text-[#F5F3FF] md:text-[42px]"
          >
            Built{" "}
            <span
          ...
          <motion.p
            ...
            className="mx-auto max-w-[600px] font-sans text-[16px] font-normal leading-[1.6] text-[#A8A0C0] md:text-[18px]"
          >
        ...
        <div className="grid grid-cols-1 gap-[20px] md:grid-cols-3">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <h3 className="mb-[10px] font-display text-[18px] font-semibold text-[#F5F3FF]">
                {feature.title}
              </h3>

              <p className="font-sans text-[14px] font-normal leading-[1.6] text-[#A8A0C0]">
                {feature.desc}
              </p>
            </motion.div>
          ))}
