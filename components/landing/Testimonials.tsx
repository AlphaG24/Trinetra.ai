      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center text-center mb-[56px] px-[20px] md:px-[40px] lg:px-[80px]">
          ...
          <motion.h2 
            ...
            className="font-display font-bold text-[32px] md:text-[42px] text-[#F5F3FF] tracking-[-0.02em] leading-tight"
          >
        ...
        {testimonials.length > 0 ? (
            ...
            <div className="w-full overflow-x-auto snap-x snap-mandatory flex gap-[24px] px-[20px] md:px-[40px] lg:px-[80px] scroll-pl-[20px] md:scroll-pl-[40px] lg:scroll-pl-[80px] pb-[40px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              {testimonials.map((t, idx) => (
                ...
                >
                  ...
                  <p className="font-sans font-normal text-[15px] text-[#A8A0C0] leading-[1.7] relative z-10 flex-grow">{t.quote}</p>
                  <div className="flex items-center gap-[14px] mt-[24px] relative z-10">
                    ...
                    <div className="flex flex-col">
                      <div className="font-sans font-semibold text-[15px] text-[#F5F3FF] leading-tight mb-[2px]">{t.name}</div>
          ...
          >
            ...
            <h3 className="font-display font-semibold text-[20px] text-[#F5F3FF]">
              We're onboarding our first clients now.
            </h3>
            <p className="font-sans font-normal text-[15px] text-[#A8A0C0] mt-[12px] max-w-[420px] leading-relaxed">
            ...
            <p className="font-sans font-medium text-[14px] text-[#A78BFA] mt-[24px]">
